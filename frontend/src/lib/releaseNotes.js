/** Release notes helpers — What’s New gate + Settings panel. */

export const LAST_SEEN_VERSION_KEY = "librarian.last_seen_version";
 ...
 * so Settings never becomes a wall of every patch number.
 *
