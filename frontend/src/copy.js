...
export const FIELD_HELP = {
  ...
  audiobook_target: "Where listeners open titles. Set to Audiobookshelf to prefer ABS handoff after Match.",
  ...
  komga_api_key: "Komga API key. Stays on this host; never committed.",
  komga_library_id: "Komga library id that mounts comics_root read-only. Librarian remains the sole writer.",
  ...
  audiobookshelf_url: "Optional Audiobookshelf base URL. After shelve, Librarian asks ABS to scan. Match + two-way listen progress when linked.",
