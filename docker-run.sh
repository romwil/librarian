...
for _env_key in \
  ...
  LLM_BASE_URL LLM_API_KEY LLM_MODEL LLM_PROVIDER DATA_HOST COMPLETE_ROOT \
  GEMINI_API_KEY GOOGLE_API_KEY GOOGLE_AI_API_KEY LIBRARIAN_GEMINI_API_KEY \
  GEMINI_BASE_URL GEMINI_MODEL \
  OPENAI_API_KEY OPENAI_BASE_URL OPENAI_MODEL \
  ANTHROPIC_API_KEY ANTHROPIC_BASE_URL ANTHROPIC_MODEL \
  HARDCOVER_API_TOKEN NYT_BOOKS_API_KEY COMICVINE_API_KEY \
...
docker run -d \
  ...
  -e LIBRARIAN_GEMINI_API_KEY="${LIBRARIAN_GEMINI_API_KEY:-}" \
  ...
  -e NYT_BOOKS_API_KEY="${NYT_BOOKS_API_KEY:-}" \
